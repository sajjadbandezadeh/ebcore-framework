...
<div class="error-container">
    ...
    <footer class="error-footer">
        <p>Ebcore Framework v<?= ebcore\framework\Core\Config::get('app.version', '1.0.0') ?></p>
        <p>Environment: <?= ebcore\framework\Core\Config::get('app.debug') ? 'Development' : 'Production' ?></p>
    </footer>
</div>
</body>
</html> 